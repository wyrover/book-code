...
#define DRV_NAME        "EnumMsgHook64"//驱动名
#define DRV_FILENAME    "EnumMsgHook64.sys"//驱动文件
#define STATUS_SUCCESS     ((NTSTATUS)0x00000000L)
typedef LONG NTSTATUS;

HANDLE hMyDrv = NULL;   //驱动句柄
...
BOOL loadDriver()
{
    ...
    (PUNICODE_STRING  DestinationString, IN PANSI_STRING  SourceString, IN BOOLEAN);
