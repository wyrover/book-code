...
HDC hDC;
const char APP_NAME[] = "BOGLGP - Chapter 9 - Multitextured Terrain";
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
    ...
    if (!g_glRender->Init()) {
        delete g_glRender;
        MessageBox(hwnd, "This demo requires an OpenGL 1.3 compliant driver. Please check your video card manufacturer's website for updates.", "Critical error", MB_OK);
        return 0;
    }
