...
__drv_dispatchType(IRP_MJ_CREATE) DRIVER_DISPATCH NdisprotOpen;
...
__drv_dispatchType(IRP_MJ_CLOSE) DRIVER_DISPATCH NdisprotClose;
NTSTATUS
NdisprotClose(
    IN PDEVICE_OBJECT   pDeviceObject,
    IN PIRP             pIrp
...
__drv_dispatchType(IRP_MJ_CLEANUP) DRIVER_DISPATCH NdisprotCleanup;
NTSTATUS
NdisprotCleanup(
    IN PDEVICE_OBJECT   pDeviceObject,
    IN PIRP             pIrp
...
__drv_dispatchType(IRP_MJ_DEVICE_CONTROL) DRIVER_DISPATCH NdisprotIoControl;
__drv_functionClass(DRIVER_DISPATCH)
__drv_requiresIRQL(PASSIVE_LEVEL)
__drv_sameIRQL
NTSTATUS
NdisprotIoControl(
    __in IN PDEVICE_OBJECT   pDeviceObject,
    __in  IN PIRP             pIrp
);
...
__drv_dispatchType(IRP_MJ_READ) DRIVER_DISPATCH NdisprotRead;
NTSTATUS
NdisprotRead(
    IN PDEVICE_OBJECT               pDeviceObject,
    IN PIRP                         pIrp
...
__drv_dispatchType(IRP_MJ_WRITE) DRIVER_DISPATCH  NdisprotWrite;
NTSTATUS
NdisprotWrite(
    IN PDEVICE_OBJECT       pDeviceObject,
    IN PIRP                 pIrp
