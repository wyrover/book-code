...
{
	/**
	 * <p>Quntic produces values that would cause a moving subject to move with very fast accelleration.</p>
	...
	public class Quintic
	{
	    ...
	    */  
		...
		{
			return (timeElapsed/=duration)*timeElapsed*timeElapsed*timeElapsed*timeElapsed;
		}
	    ...
	    */  
		...
		{
			return ((timeElapsed=timeElapsed/duration-1)*timeElapsed*timeElapsed*timeElapsed*timeElapsed + 1);
		}
		...
		{
			if ((timeElapsed/=duration/2) < 1) return 0.5*timeElapsed*timeElapsed*timeElapsed*timeElapsed*timeElapsed;
			return 0.5*((timeElapsed-=2)*timeElapsed*timeElapsed*timeElapsed*timeElapsed + 2);
		}		
