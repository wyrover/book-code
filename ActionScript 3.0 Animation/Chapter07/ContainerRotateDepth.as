package
{
	...
	public class ContainerRotateDepth extends Sprite
	{
		private var _holder:Sprite;
		private var _shapes:Array;
		
		public function ContainerRotateDepth()
		{
			_holder = new Sprite();
		...
		private function sortShapes():void
		{
			...
			{
				_holder.addChildAt(_shapes[i], i);
			}
		}
		
		private function depthSort(objA:Shape, objB:Shape):int
		{
