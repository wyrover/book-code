        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam))
            {
                ...
                case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochAttachBuffers->hResource)))
                    {
                          ...
                          LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", 
                                    pIsochDetachBuffers->pIsochDescriptor);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) 
            {
                ...
                case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochDetachBuffers->hResource)))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochDetachBuffers->pIsochDescriptor)))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
                          ...
                          LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pHandle);
                          ...
                          LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", *phResource);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) 
            {
                ...
                case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", phResource))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
                   ...
                   LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochListen->hResource);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) 
            {
                ...
                case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochListen->hResource)))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
                                ...
                                LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochSetChannelBandwidth->hBandwidth);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochSetChannelBandwidth->hBandwidth)))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
                               ...
                               __in PSTR    szDeviceName)
{
        ...
        (LPARAM)&isochSetChannelBandwidth))
    {
        ...
        if (ERROR_SUCCESS != dwRet)
        {
            TRACE (TL_WARNING, (hWnd, "Faield SendRequest %d\n", dwRet));
        }
    }
                 ...
                 LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            // put offset low and high and buffer length in edit controls
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochStop->hResource);
        ...
        case WM_COMMAND:
            ...
            switch (LOWORD(wParam)) {
                ...
                case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochStop->hResource)))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
                 ...
                 LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            // put offset low and high and buffer length in edit controls
            StringCbPrintf (tmpBuff, (STRING_SIZE * sizeof(tmpBuff[0])), "%p", pIsochTalk->hResource);
        ...
        case WM_COMMAND:
            ...
            case IDOK:
                    ...
                    if (!sscanf_s (tmpBuff, "%p", &(pIsochTalk->hResource)))
                    {
                        // failed to get the handle, just return here
                        EndDialog(hDlg, TRUE);
                        return FALSE;
