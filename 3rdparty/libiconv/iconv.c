 ...
 */
#include "include\cjk_variants.h"
#include "include\translit.h"
...
#define DEFENCODING(xxx_names,xxx,xxx_ifuncs1,xxx_ifuncs2,xxx_ofuncs1,xxx_ofuncs2) \
  ei_##xxx ,
#include "include\encodings.def"
#ifdef USE_AIX
# include "include\encodings_aix.def"
#endif
#ifdef USE_OSF1
# include "include\encodings_osf1.def"
#endif
#ifdef USE_DOS
# include "include\encodings_dos.def"
#endif
#ifdef USE_EXTRA
# include "include\encodings_extra.def"
#endif
#include "include\encodings_local.def"
#undef DEFENCODING
 ...
 */
#if defined _AIX
# include "include\aliases_sysaix.h"
#elif defined hpux || defined __hpux
# include "include\aliases_syshpux.h"
#elif defined __osf__
# include "include\aliases_sysosf1.h"
#elif defined __sun
# include "include\aliases_syssolaris.h"
#else
...
#if defined _AIX
# include "include\canonical_sysaix.h"
#elif defined hpux || defined __hpux
# include "include\canonical_syshpux.h"
#elif defined __osf__
# include "include\canonical_sysosf1.h"
#elif defined __sun
# include "include\canonical_syssolaris.h"
#else
# include "include\canonical.h"
#endif
#ifdef USE_AIX
# if defined _AIX
#  include "include\canonical_aix_sysaix.h"
# else
#  include "include\canonical_aix.h"
# endif
#endif
#ifdef USE_OSF1
# if defined __osf__
#  include "include\canonical_osf1_sysosf1.h"
# else
#  include "include\canonical_osf1.h"
# endif
#endif
#ifdef USE_DOS
# include "include\canonical_dos.h"
#endif
#ifdef USE_EXTRA
# include "include\canonical_extra.h"
#endif
#if defined _AIX
# include "include\canonical_local_sysaix.h"
#elif defined hpux || defined __hpux
# include "include\canonical_local_syshpux.h"
#elif defined __osf__
# include "include\canonical_local_sysosf1.h"
#elif defined __sun
# include "include\canonical_local_syssolaris.h"
#else
# include "include\canonical_local.h"
#endif
};
