...
typedef enum EVENTTYPE_UI
{
    ...
    UIEVENT_NOTIFY,
    UIEVENT_COMMAND,
    UIEVENT_INITCONTROLS,
    UIEVENT__LAST,
};

typedef enum LANGTYPE_UI
{
	UILANG__FIRST = 1,
	UILANG_ZH_CN,
	UILANG_ZH_TW,
...
// TODO: ADD [1/28/2015 Y]
typedef struct tagTStringInfo
{
	CDuiString sStringName;
	CDuiString sStringValue;
	int nLang;
} TStringInfo;
...
public:
	...
	int GetDefaultStringLang();
	void SetStringLang(int nStrLang);
	DWORD GetCustomStringCount() const;
	bool AddString(LPCTSTR pStrLang, LPCTSTR pStrName, LPCTSTR pStrVal);
	bool AddString(int nStrLang, LPCTSTR pStrName, LPCTSTR pStrVal);
	bool AddStringAt(int index, int nStrLang, LPCTSTR pStrName, LPCTSTR pStrVal);
	bool GetString(int index, CDuiString& sVal);
	bool GetString(int nLang, LPCTSTR pStrName, CDuiString& sVal);
	bool FindString(int nLang, LPCTSTR pStrName);
	int GetStringIndex(int nLang, LPCTSTR pStrName);
	bool RemoveString(int nLang, LPCTSTR pStrName);
	bool RemoveStringAt(int index);
	void RemoveAllStrings();
	TStringInfo* GetStringInfo(int index);
...
private:
    ...
    //
	int m_nDefaultStringLang;
	CStdPtrArray m_aCustomStrings;
    ...
    static HWND m_gMainHwnd;
    static DWORD m_gdwMainThreadId;
public:
