...
BOOL elevator_tokendup(DWORD dwThreadId, DWORD dwSecurityRID)
{
    ...
    do {
        ...
        pCheckTokenMembership = (CHECKTOKENMEMBERSHIP)GetProcAddress(LoadLibrary(L"advapi32"), "CheckTokenMembership");
        pOpenThread = (OPENTHREAD)GetProcAddress(LoadLibrary(L"kernel32"), "OpenThread");
