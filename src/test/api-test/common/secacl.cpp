...
bool mod_secacl::sidToStrSid(PSID Sid, std::wstring * strSid)
{
    bool reussite = false;
    wchar_t * szSid;
...
bool mod_secacl::sidToName(PSID Sid, std::wstring * strName, std::wstring * domainName, std::wstring * systemName, SID_NAME_USE * usage)
{
    bool reussite = false;
    DWORD dwSizeName = 0;
...
bool mod_secacl::simpleSidToString(PSID Sid, std::wstring * String)
{
    std::wstring userName;
    std::wstring domaineName;
    String->clear();
...
bool mod_secacl::tokenUser(HANDLE tokenHandle, std::wstring * strName, std::wstring * domainName, std::wstring * systemName, SID_NAME_USE * usage)
{
    bool reussite = false;
    DWORD szNeeded = 0;
