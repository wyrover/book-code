...
if args.Count < 1  Then
  wscript.Echo "Usage: cscript vss-copy.vbs [option]"
  wscript.Echo
...
Select Case args.Item(0)
  ...
  Case "/list"
    ...
    Wscript.Echo "============="
    Wscript.Echo
    Set colItems = objWMIService.ExecQuery("Select * from Win32_ShadowCopy", , 48)
    For Each objItem in colItems
      ...
      Wscript.Echo "[*] Exposed Path:        " & objItem.ExposedPath
  ...
  Case "/build"
    ...
    Set objTextFile = objFSO.OpenTextFile("vss-copy.vbs", ForReading)
