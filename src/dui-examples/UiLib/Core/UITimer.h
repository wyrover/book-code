...
public:
    void SetUserData(unUserData nUserData)
    {
        m_UserData = nUserData;
    };
    unUserData GetUserData()
    {
        return m_UserData;
    };
...
public:
    ...
    void operator()(IDuiTimer* pTimer)
    {
        return OnTimer(pTimer);
    };
    void operator()(IDuiTimer* pTimer, void* param)
    {
        return OnTimer(pTimer, param);
    };
    void operator()(IDuiTimer* pTimer, HWND hWnd, LPARAM lParam, WPARAM wParam)
    {
        return OnTimer(pTimer, hWnd, lParam, wParam);
    };
...
public:
    ...
    void SetCurTimer(LONG iCurTimer)
    {
        m_iCurTimer = iCurTimer;
    }
    void* GetObj() const
    {
        return m_pObject;
    ...
    LONG  GetTotalTimer() const
    {
        return m_iTotalTimer;
    };
    LONG  GetCurTimer() const
    {
        return m_iCurTimer;
    };
    ...
    UINT  GetTimerAccuracy() const
    {
        return m_uTimerAccuracy;
    };
    HWND  GetHwnd() const
    {
        return m_hWnd;
...
public:
    ...
    virtual void OnTimer(IDuiTimer* pTimer, HWND hWnd, LPARAM lParam, WPARAM wParam)
    {
...
public:
    ...
    virtual void KillDuiTimer()
    {
        return InnerKillTimer();
    };
    virtual TDuiTimer* Copy() const
    {
        return new TDuiTimer(*this);
    }
...
public:
    ...
    void operator+= (IDuiTimer* _DuiTimer)
    {
        (*this) += (CDuiTimerBase*)_DuiTimer;
    };
