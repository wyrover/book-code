...
public:
    ...
    FunVoid GetFunVoid() const
    {
        return m_unionFnType.pFunVoid;
    };
    FunTEvent GetFunTEvent() const
    {
        return m_unionFnType.pFunTEvent;
    };
    FunTNotify GetFunTNotify() const
    {
        return m_unionFnType.pFunTNotify;
    };
    ...
    bool operator()(TEventUI* pTEventUI, UINT _iEventType, LPARAM lParam = NULL, WPARAM wParam = NULL)
    {
        return Invoke(pTEventUI, lParam, wParam);
    };
    bool operator()(TNotifyUI* pTNotifyUI, LPCTSTR _sNotifyTypeName, LPARAM lParam = NULL, WPARAM wParam = NULL)
    {
        return Invoke(pTNotifyUI, lParam, wParam);
    };
...
protected:
    ...
    void SetNotifyTypeName(CDuiString& _sNotifyTypeName)
    {
        m_sNotifyTypeName = _sNotifyTypeName.GetData();
    };
    UINT GetEventType()
    {
        return m_iEventType;
    };
    CDuiString GetNotifyTypeName()
    {
        return m_sNotifyTypeName.GetData();
    };
...
public:
    ...
    {
        m_pCMFunVoid = rhs.m_pCMFunVoid;
        m_pCMFunTEvent = rhs.m_pCMFunTEvent;
        m_pCMFunTNotify = rhs.m_pCMFunTNotify;
    }
    virtual CDelegateBase* Copy() const
    {
