...
--*/
{
         ...
         pIrpEntry = pIrpEntry->Flink)
    {
        ...
        {
			NUIO_ASSERT(pIrpEntry == &pIrp->Tail.Overlay.ListEntry);
...
--*/
{
    ...
    DEBUGP(DL_LOUD, ("Receive: Open %p, LookaheadBufferSize %d, Size %d\n",
...
VOID
NdisuioTransferDataComplete_old(
    IN NDIS_HANDLE                  ProtocolBindingContext,
