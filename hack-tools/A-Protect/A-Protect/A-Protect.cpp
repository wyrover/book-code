...
int CMyAProtectApp::ExitInstance()
{
	//TODO: 处理可能已添加的附加资源
	AfxOleTerm(FALSE);
...
// CMyAProtectApp 消息处理程序

// CMyAProtectApp 自定义加载/保存方法

void CMyAProtectApp::PreLoadState()
{
// 	BOOL bNameValid;
// 	CString strName;
...
void CMyAProtectApp::LoadCustomState()
{
}

void CMyAProtectApp::SaveCustomState()
{
}
