...
workspace "win-info-examples"
    ...
    function create_project(name)        
        ...
        files
        {                                  
            "win-info-examples/%{prj.name}/**.h",
            "win-info-examples/%{prj.name}/**.cpp", 
            "win-info-examples/%{prj.name}/**.rc" 
        }
        removefiles
        {               
        }
    ...
    group "win-info-examples"  

        matches = os.matchdirs("win-info-examples/*")
