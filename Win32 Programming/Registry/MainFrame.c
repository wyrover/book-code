...
//                  Return 0 to continue creation of the window; 
//                  otherwise return -1 to fail the window creation.
//
...
{
    EnumChildWindows (hwnd, mainFrame_SysColorChangeEnumeration, (LPARAM) NULL) ;
}

//
//  BOOL CALLBACK
//  MainFrame_SysColorChangeEnumeration (HWND hwnd, LPARAM lParam)
//
