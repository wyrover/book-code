...
* Inputs:
*       int n: Width of string which will appear in type column (second
*	       column) as computed by the CMessageLog::GetStringWidth function
* Result: void
*       
* Effect: 
*       Initializes the message log, creating the columns and doing all the
...
* Inputs:
*	HANDLE hwnd: Handle to display, or 0 (NULL)
...
void CMessageLog::OnFilePrint() 
{
	// TODO: Add your command handler code here
	
}

void CMessageLog::OnClear() 
{
 DeleteAllItems();
	
}

void CMessageLog::OnMark() 
{
 CString mark;

 // TODO: prompt the user for the mark...
 CString s;
 s.Format(_T("------------------------%s------------------------"), mark);

 addMessage(NULL, _T(""), s);
            
}

void CMessageLog::OnContextMenu(CWnd* pWnd, CPoint point) 
{
 CMenu menu;
