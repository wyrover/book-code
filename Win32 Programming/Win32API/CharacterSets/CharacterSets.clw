...
[General Info]
Version=1
LastClass=CCharacterSetsView
LastTemplate=CDialog
NewFileInclude1=#include "stdafx.h"
NewFileInclude2=#include "CharacterSets.h"
LastPage=0

ClassCount=8
Class1=CCharacterSetsApp
Class2=CCharacterSetsDoc
Class3=CCharacterSetsView
Class4=CMainFrame
Class7=CAboutDlg
Class8=CChildFrame

ResourceCount=5
Resource1=IDR_OEMTYPE
Resource2=IDR_MAINFRAME
Resource3=IDR_CHARACTYPE
Resource4=IDR_ANSITYPE
Resource5=IDD_ABOUTBOX

[CLS:CCharacterSetsApp]
Type=0
HeaderFile=CharacterSets.h
ImplementationFile=CharacterSets.cpp
Filter=N

[CLS:CCharacterSetsDoc]
Type=0
HeaderFile=CharacterSetsDoc.h
ImplementationFile=CharacterSetsDoc.cpp
Filter=N

[CLS:CCharacterSetsView]
Type=0
HeaderFile=CharacterSetsView.h
ImplementationFile=CharacterSetsView.cpp
Filter=C
