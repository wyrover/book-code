...
/* Object interface: IUpdateReceipt, ver. 0.0,
   GUID={0xFA1CAAD5,0x7CAB,0x11D4,{0x8B,0xF1,0x02,0xA5,0x4B,0x00,0x00,0x00}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IUpdateReceipt_ServerInfo;
...
static const unsigned short IUpdateReceipt_FormatStringOffsetTable[] = {
    (unsigned short) - 1,
    (unsigned short) - 1,
    (unsigned short) - 1,
    (unsigned short) - 1,
...
static const MIDL_SERVER_INFO IUpdateReceipt_ServerInfo = {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IUpdateReceipt_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IUpdateReceipt_ProxyInfo = {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IUpdateReceipt_FormatStringOffsetTable[-3],
    0,
...
CINTERFACE_PROXY_VTABLE(8) _IUpdateReceiptProxyVtbl = {
    &IUpdateReceipt_ProxyInfo,
    &IID_IUpdateReceipt,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* (void *)-1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) - 1 /* IUpdateReceipt::Update */
};


static const PRPC_STUB_FUNCTION IUpdateReceipt_table[] = {
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IUpdateReceiptStubVtbl = {
    &IID_IUpdateReceipt,
    &IUpdateReceipt_ServerInfo,
    8,
    &IUpdateReceipt_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
const CInterfaceProxyVtbl * _Bank_ProxyVtblList[] = {
    ...
    (CInterfaceProxyVtbl *) &_IUpdateReceiptProxyVtbl,
    0
};
...
{
    IID_BS_LOOKUP_SETUP
    IID_BS_LOOKUP_INITIAL_TEST(_Bank, 4, 2)
    IID_BS_LOOKUP_NEXT_TEST(_Bank, 1)
    IID_BS_LOOKUP_RETURN_RESULT(_Bank, 4, *pIndex)
}
