...
/* Object interface: IAccount, ver. 0.0,
   GUID={0x3B4F8E7A,0x80C1,0x11D4,{0xA2,0x3D,0x02,0x60,0x8C,0xAC,0xED,0xBB}} */
...
const CInterfaceProxyVtbl * _ATLSample_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IAccountProxyVtbl,
    0
};

const CInterfaceStubVtbl * _ATLSample_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IAccountStubVtbl,
    0
};

PCInterfaceName const _ATLSample_InterfaceNamesList[] = {
    "IAccount",
    0
};

const IID *  _ATLSample_BaseIIDList[] = {
    &IID_IDispatch,
    0
};


#define _ATLSample_CHECK_IID(n) IID_GENERIC_CHECK_IID( _ATLSample, pIID, n)

int __stdcall _ATLSample_IID_Lookup(const IID * pIID, int * pIndex)
{
    if (!_ATLSample_CHECK_IID(0)) {
        *pIndex = 0;
        return 1;
    }
...
const ExtendedProxyFileInfo ATLSample_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _ATLSample_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ATLSample_StubVtblList,
    (const PCInterfaceName *) & _ATLSample_InterfaceNamesList,
    (const IID **) & _ATLSample_BaseIIDList,
    & _ATLSample_IID_Lookup,
    1,
    2,
