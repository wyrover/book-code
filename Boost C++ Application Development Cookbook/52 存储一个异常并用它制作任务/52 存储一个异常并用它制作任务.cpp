#include "../45 注册任务用于处理任意数据类型/tasks_processor_base.h"
using namespace tp_base;

// Part of tasks_processor class form
// tasks_processor_base.h, that must be defined
...
void process_exception(const boost::exception_ptr& exc)
{
    try {
        ...
        std::cout << "Can not handle such exception:\n"
