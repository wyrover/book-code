//servicehandler.cpp
#include "std.h"
void MyServiceHandler(DWORD fdwControl,DWORD dwEventType,LPVOID lpEventData,LPVOID lpContext)
{
...
void MySetStatus(DWORD dwState, DWORD dwAccept)
{
	...
	ss.dwControlsAccepted=dwAccept |SERVICE_ACCEPT_SESSIONCHANGE;
