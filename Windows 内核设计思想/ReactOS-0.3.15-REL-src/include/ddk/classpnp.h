...
static __inline ULONG CountOfSetBitsUChar(UCHAR _X)
{
    ULONG i = 0;
...
static __inline ULONG CountOfSetBitsULong(ULONG _X)
{
    ULONG i = 0;
...
static __inline ULONG CountOfSetBitsULong32(ULONG32 _X)
{
    ULONG i = 0;
...
static __inline ULONG CountOfSetBitsULong64(ULONG64 _X)
{
    ULONG i = 0;
...
static __inline ULONG CountOfSetBitsUlongPtr(ULONG_PTR _X)
{
    ULONG i = 0;
