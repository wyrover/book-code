...
#undef Fvec32s4_COMP
    ...
    friend F32vec4 simd_min(const F32vec4 &a, const F32vec4 &b)
    {
...
inline Is16vec4 simd_max(const Is16vec4 &a, const Is16vec4 &b)
{
    return _m_pmaxsw(a, b);
}
inline Is16vec4 simd_min(const Is16vec4 &a, const Is16vec4 &b)
{
    return _m_pminsw(a, b);
}
inline Iu8vec8 simd_max(const Iu8vec8 &a, const Iu8vec8 &b)
{
    return _m_pmaxub(a, b);
}
inline Iu8vec8 simd_min(const Iu8vec8 &a, const Iu8vec8 &b)
{
    return _m_pminub(a, b);
}
inline Iu16vec4 simd_avg(const Iu16vec4 &a, const Iu16vec4 &b)
{
    return _m_pavgw(a, b);
}
inline Iu8vec8 simd_avg(const Iu8vec8 &a, const Iu8vec8 &b)
{
    return _m_pavgb(a, b);
}
inline int move_mask(const I8vec8 &a)
{
    return _m_pmovmskb(a);
}
inline Iu16vec4 mul_high(const Iu16vec4 &a, const Iu16vec4 &b)
{
    return _m_pmulhuw(a, b);
}
inline void mask_move(const I8vec8 &a, const I8vec8 &b, char *addr)
{
    _m_maskmovq(a, b, addr);
}
inline void store_nta(__m64 *p, M64 &a)
{
    _mm_stream_pi(p, a);
}
...
#undef Fvec32s1_COMP
    ...
    friend F32vec1 simd_min(const F32vec1 &a, const F32vec1 &b)
    {
