...
public:
    ...
    iterator begin()
    {
        return cast_traits::to_value_type_ptr(_M_impl.begin());
    }
    const_iterator begin() const
    {
        return cast_traits::to_value_type_cptr(_M_impl.begin());
    }
    iterator end()
    {
        return cast_traits::to_value_type_ptr(_M_impl.end());
    }
    const_iterator end() const
    {
        return cast_traits::to_value_type_cptr(_M_impl.end());
    }
