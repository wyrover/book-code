...
template <class _CharT, class _Alloc>
inline _CharT* value_type(const _Rope_iterator<_CharT, _Alloc>&)
{
    return 0;
}
template <class _CharT, class _Alloc>
inline ptrdiff_t* distance_type(const _Rope_iterator<_CharT, _Alloc>&)
{
    return 0;
}
template <class _CharT, class _Alloc>
...
template <class _CharT, class _Alloc>
inline _CharT* value_type(const _Rope_const_iterator<_CharT, _Alloc>&)
{
    return 0;
}
template <class _CharT, class _Alloc>
inline ptrdiff_t* distance_type(const _Rope_const_iterator<_CharT, _Alloc>&)
{
    return 0;
}
...
public:
    allocator_type get_allocator() const
    {
        return allocator_type(_M_tree_ptr);
    }
...
inline void swap(crope& __x, crope& __y)
{
    __x.swap(__y);
}
# ifdef _STLP_HAS_WCHAR_T  // dwa 8/21/97
inline void swap(wrope& __x, wrope& __y)
{
    __x.swap(__y);
}
# endif
