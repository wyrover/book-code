...
public:
    ...
    iterator end()
    {
        return iterator(&this->_M_header._M_data);
    }
    const_iterator end() const
    {
        return const_iterator(__CONST_CAST(_Base_ptr, &this->_M_header._M_data));
    }
...
public:
    ...
    {
        return const_iterator(_M_find(__k));
    }
private:
    _STLP_TEMPLATE_FOR_CONT_EXT
...
public:
    ...
    {
        return const_iterator(_M_lower_bound(__x));
    }
    _STLP_TEMPLATE_FOR_CONT_EXT
    ...
    {
        return const_iterator(_M_upper_bound(__x));
    }
    _STLP_TEMPLATE_FOR_CONT_EXT
