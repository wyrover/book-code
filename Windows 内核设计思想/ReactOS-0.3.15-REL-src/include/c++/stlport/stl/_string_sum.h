...
public:
    ...
    {
        return _M_get_storage().begin();
    }
    const_iterator end()   const
    {
        return _M_get_storage().end();
    }
    const_reverse_iterator rbegin() const
    {
        return _M_get_storage().rbegin();
    }
    const_reverse_iterator rend()   const
    {
        return _M_get_storage().rend();
    }
    ...
    {
        return _M_get_storage().max_size();
    }
    ...
    {
        return _M_get_storage().assign(__s, __pos, __n);
    }
    _BString& assign(const _CharT* __s, size_type __n)
    {
        return _M_get_storage().assign(__s, __n);
    }
    ...
    {
        return _M_get_storage().assign(__n, __c);
    }

    //insert
    _BString& insert(size_type __pos, const _BString& __s)
    {
        return _M_get_storage().insert(__pos, __s);
    }
    ...
    {
        return _M_get_storage().insert(__pos, __s, __n);
    }
    ...
    {
        return _M_get_storage().insert(__pos, __n, __c);
    }

    //erase
    _BString& erase(size_type __pos = 0, size_type __n = _BString::npos)
    {
        return _M_get_storage().erase(__pos, __n);
    }
    ...
    const _CharT* c_str() const
    {
        return _M_get_storage().c_str();
    }
    const _CharT* data()  const
    {
        return _M_get_storage().data();
    }

    //find family
    size_type find(const _BString& __s, size_type __pos = 0) const
    {
        return _M_get_storage().find(__s, __pos);
    }
    ...
    {
        return _M_get_storage().find(__s, __pos, __n);
    }
    ...
    {
        return _M_get_storage().rfind(__s, __pos);
    }
    ...
    {
        return _M_get_storage().rfind(__s, __pos, __n);
    }
