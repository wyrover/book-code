...
struct _DbgTraits : _Traits {
    ...
    static bool _Check(const _Iterator&)
    {
        return true;
    }
};
...
public:
    ...
    const __owned_link* _Next() const
    {
        return _M_next;
    }
...
public:
    ...
    const __owned_link* _First() const
    {
        return (__owned_link*)_M_node._M_next;
    }
    const __owned_link* _Last() const
    {
        return 0 ;
    }
...
private:
    ...
    __owned_list& operator = (const __owned_list&)
    {
        return *this;
    }
