...
inline _STLP_VENDOR_CSTD::div_t div(int __x, int __y)
{
...
inline _STLP_VENDOR_CSTD::ldiv_t div(long __x, long __y)
{
...
{
    return _STLP_VENDOR_CSTD::llabs(__x);
}
inline lldiv_t div(_STLP_LONG_LONG __x, _STLP_LONG_LONG __y)
{
    return _STLP_VENDOR_CSTD::lldiv(__x, __y);
}
#    else
inline _STLP_LONG_LONG  abs(_STLP_LONG_LONG __x)
{
