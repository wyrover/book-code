...
template<class _Tp>
struct _UnConstPtr<_Tp*> {
    typedef _Tp _Type;
};

template<class _Tp>
struct _UnConstPtr<const _Tp*> {
    typedef _Tp _Type;
};
#    endif
...
template <class _Tp>
struct _IsConst {
    typedef _AreSameTypes<_Tp, const _Tp>::_Ret _Ret;
};
#    endif
...
template <class _Tp>
struct _IsVolatile {
    typedef _AreSameTypes<_Tp, volatile _Tp>::_Ret _Ret;
};
...
#    if !defined (_STLP_QUALIFIED_SPECIALIZATION_BUG)
template <class _Tp> struct _UnQual {
    typedef _Tp _Type;
};
template <class _Tp> struct _UnQual<const _Tp> {
    typedef _Tp _Type;
};
template <class _Tp> struct _UnQual<volatile _Tp> {
    typedef _Tp _Type;
};
template <class _Tp> struct _UnQual<const volatile _Tp> {
    typedef _Tp _Type;
};
#    endif
#  endif
