...
int
_declspec(naked)
RtlCompareMemoryUlong(int, int, int)
...
int
_declspec(naked)
RtlFillMemoryUlong(int, int, int)
...
int
_declspec(naked)
RtlFillMemoryUlonglong(int, int, int, int)
