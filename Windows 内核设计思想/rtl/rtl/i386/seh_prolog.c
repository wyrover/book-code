...
#define OLDFRAME_ReturnAddress     0 /* 0x00 */
#define OLDFRAME_SEHTable          4 /* 0x04 */
#define OLDFRAME_StackBytes        8 /* 0x08 */
#define OLDFRAME_Size             12 /* 0x0c */

#define SEH_FRAME_NewEsp           0 /* 0x00 */
#define SEH_FRAME_unused           4 /* 0x04 */
#define SEH_FRAME_PreviousRecord   8 /* 0x08 */
#define SEH_FRAME_Handler         12 /* 0x0c */
#define SEH_FRAME_SEHTable        16 /* 0x10 */
#define SEH_FRAME_Disable         20 /* 0x14 */
#define SEH_FRAME_OriginalEbp     24 /* 0x18 */
#define SEH_FRAME_Size            28 /* 0x1c */

#define SAFE_AREA_Edi              0 /* 0x00 */
#define SAFE_AREA_Esi              4 /* 0x04 */
#define SAFE_AREA_Ebx              8 /* 0x08 */
#define SAFE_AREA_Size            12 /* 0x0c */


//.code
_declspec(naked)_SEH_prolog()
{
    _asm{
//PUBLIC __SEH_prolog
//__SEH_prolog:
