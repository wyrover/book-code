 ...
 */
/* $Id: fsctl.c 31753 2008-01-13 11:36:54Z cwittich $
 *
...
//#endif
    ...
    NtfsReadSectors(DeviceObject, 1, 4, DiskGeometry.BytesPerSector, (PVOID)&NtfsGlobalData->BootFile, TRUE);
...
//                          FILE_DEVICE_DISK_FILE_SYSTEM,
    ...
    NewDeviceObject->Vpb = Vpb;//DeviceToMount->Vpb;
    DeviceExt->StorageDevice = Vpb->RealDevice;//DeviceToMount;
