...
__local_unwind2();
__declspec(naked) _ValidateEH3RN()
{
    _asm{
        mov     edi, edi
        push    ebp
...
__declspec(naked) NTAPI _NLG_Notify()
{
    _asm{
...
//.code
//_unwind_handler:
_declspec(naked) _unwind_handler()
{
    _asm{
...
//__global_unwind2:
_declspec(naked) __global_unwind2()
{
    _asm{
...
_declspec(naked) __abnormal_termination()
{
    _asm{
        /* Assume false */
        xor eax, eax
...
//__local_unwind2:
_declspec(naked) __local_unwind2()
{
    _asm{
        /* Save volatiles */
        push ebx
...
//__except_handler2:
_declspec(naked) __except_handler2()
{
    _asm{
...
//__except_handler3:
_declspec(naked) _except_handler3()
{
    _asm{
        /* Setup stack and save volatiles */
        push ebp
