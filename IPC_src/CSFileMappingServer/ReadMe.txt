========================================================================
    CONSOLE APPLICATION : CSFileMappingServer Project Overview
========================================================================
...
This sample demonstrates a named shared memory server, 
Local\HelloWorld, that creates the file mapping object with 
INVALID_HANDLE_VALUE. By using the PAGE_READWRITE flag, the process has 
...
3. Write message to the file view. (Marshal.Copy)
