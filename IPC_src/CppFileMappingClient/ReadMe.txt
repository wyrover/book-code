========================================================================
    CONSOLE APPLICATION : CppFileMappingClient Project Overview
========================================================================
...
that can access the string written to the shared memory by the first process. 
The console displays the message "Message from the first process" that is 
read from the file mapping created by the first process.
