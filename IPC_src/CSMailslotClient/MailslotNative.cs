...
* 
* History:
* * 3/10/2009 1:15 PM Riquel Dong Created
...
public class MailslotNative
{
    ...
    /// <param name="lpBuffer">A buffer that receives the data read
    /// from a file</param>
    /// <param name="nNumberOfBytesToRead">The maximum number of 
    /// bytes to be read</param>
    /// <param name="lpNumberOfBytesRead">the number of bytes read</param>
    /// <param name="lpOverlapped">A pointer to an OVERLAPPED 
    /// structure.</param>
    ...
    /// the pipe;The number of bytes requested is read;An error 
    /// occurs</returns>
