/****************************** Module Header ******************************\
* Module Name:	NamedPipeNative.cs
...
* 
* History:
* * 1/27/2009 9:15 PM Jialiang Ge Created
\***************************************************************************/
...
public class PipeNative
{
    ...
    /// </param>
    /// <returns>If an instance of the pipe is available before the time-out 
    /// interval elapses, the return value is nonzero.</param>
    [DllImport("kernel32.dll", SetLastError = true)]
    ...
    /// computer before transmission to the server.</param>
    ...
    /// <param name="lpBuffer">Pointer to the buffer containing the data
    /// to be written to the file.</param>
    /// <param name="nNumberOfBytesToWrite">Number of bytes to be write
    /// to the file.</param>
