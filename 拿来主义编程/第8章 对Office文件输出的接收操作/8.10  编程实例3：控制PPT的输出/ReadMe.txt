========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : VcPPT
========================================================================


AppWizard has created this VcPPT application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your VcPPT application.
...
res\VcPPT.ico
    ...
    icon is included by the main resource file VcPPT.rc.
...
VcPPTDlg.h, VcPPTDlg.cpp - the dialog
    These files contain your CVcPPTDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in VcPPT.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CVcPPTDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named VcPPT.pch and a precompiled types file named StdAfx.obj.
