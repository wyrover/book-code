...
varapi (ulong)   Readmemory(void *buf,ulong addr,ulong size,int mode);
varapi (ulong)   Readmemoryex(void *buf,ulong addr,ulong size,int mode,
                   ulong threadid);
...
varapi (ulong)   Disasm(uchar *cmd,ulong cmdsize,ulong cmdip,uchar *cmddec,
...
varapi (void)    Redrawcpudisasm(void);
varapi (void)    Redrawcpureg(void);
varapi (ulong)   Getcputhreadid(void);
varapi (int)     Getcpuruntracebackstep(void);
varapi (t_dump *) Getcpudisasmdump(void);
varapi (ulong)   Getcpudisasmselection(void);
varapi (t_table *) Getcpudisasmtable(void);
varapi (void)    Addtohistory(t_history *ph,ulong threadid,ulong dumptype,
                   ulong addr,ulong sel0,ulong sel1);
varapi (int)     Walkhistory(t_history *ph,int dir,ulong *threadid,
                   ulong *dumptype,ulong *addr,ulong *sel0,ulong *sel1);
varapi (int)     Checkhistory(t_history *ph,int dir,int *isnewest);
varapi (void)    Setcpu(ulong threadid,ulong asmaddr,ulong dumpaddr,
...
_export t_menu* cdecl ODBG2_Pluginmenu(wchar_t *type);
