...
// This is the modification of Example 7-4 discussed on
// pp. 162 and 163.
#include <list.h>
#include <multiset.h>
#include <assert.h>
...
int main()
{
  ...
  pair<multiset<char, less<char> >::iterator,
       multiset<char, less<char> >::iterator> 
  ...
  assert(lst1(multiset1) == lst("       ATaaaatttvy"));
