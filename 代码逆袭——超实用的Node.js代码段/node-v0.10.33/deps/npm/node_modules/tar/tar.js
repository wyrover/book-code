...
var types =
  ...
  // posix headers
  , g: "GlobalExtendedHeader" // txtlink=v for the rest of the archive
  , x: "ExtendedHeader" // txtlink=v for the next file
  // vendor-specific stuff
  , A: "SolarisACL" // skip
  , D: "GNUDumpDir" // like 5, but with data, which should be skipped
  , I: "Inode" // metadata only, skip
  , K: "NextFileHasLongLinkpath" // data = txtlink path of next file
