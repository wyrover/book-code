...
// Operations
public:
		CPalette *CreateBitmapPalette( ZaoShengXiaoChuDib* pBitmap);
 		CString filename;
		ZaoShengXiaoChuDib *CDibNew1;
		CDib *CDib1;
		CPalette hPalette;
		int state2;
		void clearmem();
...
protected:
	...
	afx_msg void OnXiaochuheidian();
	afx_msg void On33junzhi();
	afx_msg void OnNnjunzhi();
	afx_msg void OnJubupingjun();
	afx_msg void OnNnzhongzhi();
	afx_msg void OnShizi();
	afx_msg void OnNnzuida();
	afx_msg void OnSuijizaosheng();
	afx_msg void OnJiaoyanzaosheng();
	afx_msg void OnFanzhuan();
	afx_msg void OnChaoxian();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
