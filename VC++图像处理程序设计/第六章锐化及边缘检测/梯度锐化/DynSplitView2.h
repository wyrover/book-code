...
// Operations
public:
		CPalette *CreateBitmapPalette( TiDuRuiHuaDib* pBitmap);
 		CString filename;
		TiDuRuiHuaDib *CDibNew1;
		CDib *CDib1;
		CPalette hPalette;
		int state2;
		void clearmem();
...
protected:
	...
	afx_msg void OnMenxianruihua();
	afx_msg void OnErzhiruihua();
	afx_msg void OnGuDingYuZhi();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
