// 11_2_1_7.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
    ...
    LoadString(hInstance, IDC_MY11_2_1_7, szWindowClass, MAX_LOADSTRING);
    ...
    hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_MY11_2_1_7);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, (LPCTSTR)IDI_MY11_2_1_7);
    wcex.hCursor        = LoadCursor(NULL, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName   = (LPCSTR)IDC_MY11_2_1_7;
