// 7_1_4_1.cpp : Defines the entry point for the application.
//
                     ...
                     int       nCmdShow)
{
    ...
    LoadString(hInstance, IDC_MY7_1_4_1, szWindowClass, MAX_LOADSTRING);
    ...
    hAccelTable = LoadAccelerators(hInstance, (LPCTSTR)IDC_MY7_1_4_1);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, (LPCTSTR)IDI_MY7_1_4_1);
    wcex.hCursor        = LoadCursor(NULL, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName   = (LPCSTR)IDC_MY7_1_4_1;
