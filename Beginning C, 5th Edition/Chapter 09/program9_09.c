...
int valid_moves(char board[][SIZE], bool moves[][SIZE], char player)
{
    ...
    for (size_t row = 0 ; row < SIZE ; ++row)
        for (size_t col = 0 ; col < SIZE ; ++col) {
            ...
            // Check all the squares around the blank square opponents counter
                ...
                for (coldelta = -1 ; coldelta <= 1 ; ++coldelta) {
                    ...
                    if (board[row + rowdelta][col + coldelta] == opponent) {
                        ...
                        for (;;) {
                            ...
                            // If we move outside the array or it's blank square, give up
        ...
        for (coldelta = -1; coldelta <= 1; ++coldelta) {
            ...
            if (board[row + rowdelta][col + coldelta] == opponent) {
                ...
                for (;;) {
                    ...
                    if (board[x][y] == ' ')     // If square is blank...
                        break;                    // ...give up
