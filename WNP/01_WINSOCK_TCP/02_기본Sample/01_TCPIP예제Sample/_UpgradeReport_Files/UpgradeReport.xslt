...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        <th></th>
        <th _locID="ProjectTableHeader">프로젝트</th>
        <th _locID="PathTableHeader">경로</th>
        <th _locID="ErrorsTableHeader">오류</th>
        <th _locID="WarningsTableHeader">경고</th>
        <th _locID="MessagesTableHeader">메시지</th>
      </tr>
              ...
              <a>
                ...
                <xsl:choose>
                  <xsl:when test="@ProjectDisplayName = ''">
                    <span _locID="OverviewSolutionSpan">솔루션</span>
                  </xsl:when>
                  <xsl:otherwise>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          표시 <xsl:value-of select="@MessageCount"/> 추가 메시지
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          숨기기 <xsl:value-of select="@MessageCount"/> 추가 메시지
        </a>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="Projects" mode="ProjectDetails">
    ...
    <xsl:for-each select="Project">
      ...
      <xsl:choose>
        <xsl:when test="@ProjectDisplayName = ''">
          <h3 _locID="ProjectDisplayNameHeader">솔루션</h3>
        </xsl:when>
        <xsl:otherwise>
          <h3>
            <xsl:value-of select="@ProjectDisplayName"/>
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">메시지</th>
        </tr>
              ...
              <xsl:choose>
                <xsl:when test="@ProjectDisplayName = ''">
                  <td class="messageCell" _locID="NoMessagesRow2">
                    솔루션이 메시지를 기록하지 않았습니다.
                  </td>
                </xsl:when>
                <xsl:otherwise>
                  <td class="messageCell" _locID="NoMessagesRow">
                    <xsl:value-of select="@ProjectDisplayName"/> 메시지가 기록되지 않았습니다.
                  </td>
                </xsl:otherwise>
              </xsl:choose>
            </tr>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          마이그레이션 보고서 - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">개요</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">솔루션 및 프로젝트</h2>
