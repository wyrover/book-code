========================================================================
    ACTIVE TEMPLATE LIBRARY : MathDll Project Overview
========================================================================

AppWizard has created this MathDll project for you to use as the starting point for
...
_MathDll.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_MathDll.h)
        GUID definitions                                (_MathDll_i.c)
        A type library                                  (_MathDll.tlb)
        Marshaling code                                 (_MathDll_p.c and dlldata.c)
MathDll.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named MathDll.pch and a precompiled types file named StdAfx.obj.
...
MathDllps.vcproj
	...
	dlldata.c, MathDll_i.c and MathDll_p.c which are required
