========================================================================
    ACTIVE TEMPLATE LIBRARY : MathService Project Overview
========================================================================

AppWizard has created this MathService project for you to use as the starting point for
...
_MathService.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_MathService.h)
        GUID definitions                                (_MathService_i.c)
        A type library                                  (_MathService.tlb)
        Marshaling code                                 (_MathService_p.c and dlldata.c)
MathService.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named MathService.pch and a precompiled types file named StdAfx.obj.
...
MathServiceps.vcproj
	...
	dlldata.c, MathService_i.c and MathService_p.c which are required
