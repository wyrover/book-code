========================================================================
    ACTIVE TEMPLATE LIBRARY : LicenseDemo Project Overview
========================================================================

AppWizard has created this LicenseDemo project for you to use as the starting point for
...
_LicenseDemo.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_LicenseDemo.h)
        GUID definitions                                (_LicenseDemo_i.c)
        A type library                                  (_LicenseDemo.tlb)
        Marshaling code                                 (_LicenseDemo_p.c and dlldata.c)
LicenseDemo.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named LicenseDemo.pch and a precompiled types file named StdAfx.obj.
...
LicenseDemops.vcproj
	...
	dlldata.c, LicenseDemo_i.c and LicenseDemo_p.c which are required
