========================================================================
    ACTIVE TEMPLATE LIBRARY : AcePowell Project Overview
========================================================================

AppWizard has created this AcePowell project for you to use as the starting point for
...
_AcePowell.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_AcePowell.h)
        GUID definitions                                (_AcePowell_i.c)
        A type library                                  (_AcePowell.tlb)
        Marshaling code                                 (_AcePowell_p.c and dlldata.c)
AcePowell.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named AcePowell.pch and a precompiled types file named StdAfx.obj.
...
AcePowellps.vcproj
	...
	dlldata.c, AcePowell_i.c and AcePowell_p.c which are required
