========================================================================
    ACTIVE TEMPLATE LIBRARY : Architect Project Overview
========================================================================

AppWizard has created this Architect project for you to use as the starting point for
...
_Architect.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Architect.h)
        GUID definitions                                (_Architect_i.c)
        A type library                                  (_Architect.tlb)
        Marshaling code                                 (_Architect_p.c and dlldata.c)
Architect.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Architect.pch and a precompiled types file named StdAfx.obj.
...
Architectps.vcproj
	...
	dlldata.c, Architect_i.c and Architect_p.c which are required
