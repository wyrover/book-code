========================================================================
    ACTIVE TEMPLATE LIBRARY : MemMgrTest Project Overview
========================================================================

AppWizard has created this MemMgrTest project for you to use as the starting point for
...
_MemMgrTest.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_MemMgrTest.h)
        GUID definitions                                (_MemMgrTest_i.c)
        A type library                                  (_MemMgrTest.tlb)
        Marshaling code                                 (_MemMgrTest_p.c and dlldata.c)
MemMgrTest.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named MemMgrTest.pch and a precompiled types file named StdAfx.obj.
...
MemMgrTestps.vcproj
	...
	dlldata.c, MemMgrTest_i.c and MemMgrTest_p.c which are required
