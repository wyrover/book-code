========================================================================
    ACTIVE TEMPLATE LIBRARY : MyObject Project Overview
========================================================================

AppWizard has created this MyObject project for you to use as the starting point for
...
_MyObject.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_MyObject.h)
        GUID definitions                                (_MyObject_i.c)
        A type library                                  (_MyObject.tlb)
        Marshaling code                                 (_MyObject_p.c and dlldata.c)
MyObject.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named MyObject.pch and a precompiled types file named StdAfx.obj.
...
MyObjectps.vcproj
	...
	dlldata.c, MyObject_i.c and MyObject_p.c which are required
