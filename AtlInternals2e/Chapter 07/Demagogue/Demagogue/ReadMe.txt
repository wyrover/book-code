========================================================================
    ACTIVE TEMPLATE LIBRARY : Demagogue Project Overview
========================================================================

AppWizard has created this Demagogue project for you to use as the starting point for
...
_Demagogue.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Demagogue.h)
        GUID definitions                                (_Demagogue_i.c)
        A type library                                  (_Demagogue.tlb)
        Marshaling code                                 (_Demagogue_p.c and dlldata.c)
Demagogue.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Demagogue.pch and a precompiled types file named StdAfx.obj.
...
Demagogueps.vcproj
	...
	dlldata.c, Demagogue_i.c and Demagogue_p.c which are required
