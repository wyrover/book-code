...
//
// The function "mymagic" contains the normal interface for the "mymagic" M-function from file "d:\vc2005\exp_13_3_4\mymagic.m" (lines 1-3). This function processes any input arguments and passes them to the implementation version of the function, appearing above.
//
...
//
// The function "mlxMymagic" contains the feval interface for the "mymagic" M-function from file "d:\vc2005\exp_13_3_4\mymagic.m" (lines 1-3). The feval function calls the implementation version of mymagic through this function. This function processes any input arguments and passes them to the implementation version of the function, appearing above.
//
...
//
// The function "Mmymagic" is the implementation version of the "mymagic" M-function from file "d:\vc2005\exp_13_3_4\mymagic.m" (lines 1-3). It contains the actual compiled code for that M-function. It is a static function and must only be called from one of the interface functions, appearing below.
//
//
// % Éú³Énxn»Ã·½¾ØÕóX
// function X = mymagic(n)
//
#line 2 "d:\\vc2005\\exp_13_3_4\\mymagic.m"
static mwArray Mmymagic(int nargout_, mwArray n) {
    #line 2 "d:\\vc2005\\exp_13_3_4\\mymagic.m"
    mclMlineEnterFunction("d:\\vc2005\\exp_13_3_4\\mymagic.m", "mymagic")
    #line 2 "d:\\vc2005\\exp_13_3_4\\mymagic.m"
    ...
    // X = magic(n);
    //
    #line 3 "d:\\vc2005\\exp_13_3_4\\mymagic.m"
    X = magic(mwVa(n, "n"));
    #line 3 "d:\\vc2005\\exp_13_3_4\\mymagic.m"
