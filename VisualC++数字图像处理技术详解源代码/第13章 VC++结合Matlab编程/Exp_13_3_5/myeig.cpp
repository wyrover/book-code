...
//
// The function "mlxMyeig" contains the feval interface for the "myeig" M-function from file "d:\vc2005\exp_13_3_5\myeig.m" (lines 1-3). The feval function calls the implementation version of myeig through this function. This function processes any input arguments and passes them to the implementation version of the function, appearing above.
//
void mlxMyeig(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]) {
    MW_BEGIN_MLX();
    {
        mwArray mprhs[1];
        mwArray mplhs[1];
        ...
        if (nlhs > 1) {
            error(mwVarargin(mwArray("Run-time Error: File: myeig Line: 2 Column: 1 The function \"myeig\" was called with more than the declared number of outputs (1).")));
        }
        if (nrhs > 1) {
            error(mwVarargin(mwArray("Run-time Error: File: myeig Line: 2 Column: 1 The function \"myeig\" was called with more than the declared number of inputs (1).")));
        }
...
//
// The function "Mmyeig" is the implementation version of the "myeig" M-function from file "d:\vc2005\exp_13_3_5\myeig.m" (lines 1-3). It contains the actual compiled code for that M-function. It is a static function and must only be called from one of the interface functions, appearing below.
//
//
// % Çó¾ØÕóXÌØÕ÷ÖµE
// function E = myeig(X)
//
#line 2 "d:\\vc2005\\exp_13_3_5\\myeig.m"
static mwArray Mmyeig(int nargout_, mwArray X) {
    #line 2 "d:\\vc2005\\exp_13_3_5\\myeig.m"
    mclMlineEnterFunction("d:\\vc2005\\exp_13_3_5\\myeig.m", "myeig")
    #line 2 "d:\\vc2005\\exp_13_3_5\\myeig.m"
    mwLocalFunctionTable save_local_function_table_ = &_local_function_table_myeig;
    #line 2 "d:\\vc2005\\exp_13_3_5\\myeig.m"
    mwArray E = mwArray::UNDEFINED;
    //
    // E = eig(X);
    //
    #line 3 "d:\\vc2005\\exp_13_3_5\\myeig.m"
    E = eig(mwVa(X, "X"));
    #line 3 "d:\\vc2005\\exp_13_3_5\\myeig.m"
    mwValidateOutput(E, 1, nargout_, "E", "myeig");
    #line 3 "d:\\vc2005\\exp_13_3_5\\myeig.m"
