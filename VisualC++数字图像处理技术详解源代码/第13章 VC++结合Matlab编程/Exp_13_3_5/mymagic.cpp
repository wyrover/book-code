...
static mwArray Mmymagic(int nargout_, mwArray n);

_mexLocalFunctionTable _local_function_table_mymagic = { 0, (mexFunctionTableEntry *)NULL };

//
// The function "mymagic" contains the normal interface for the "mymagic" M-function from file "d:\vc2005\exp_13_3_5\mymagic.m" (lines 1-3). This function processes any input arguments and passes them to the implementation version of the function, appearing above.
//
mwArray mymagic(mwArray n) {
    int nargout = 1;
    mwArray X = mwArray::UNDEFINED;
    X = Mmymagic(nargout, n);
    return X;
}

//
// The function "mlxMymagic" contains the feval interface for the "mymagic" M-function from file "d:\vc2005\exp_13_3_5\mymagic.m" (lines 1-3). The feval function calls the implementation version of mymagic through this function. This function processes any input arguments and passes them to the implementation version of the function, appearing above.
//
void mlxMymagic(int nlhs, mxArray * plhs[], int nrhs, mxArray * prhs[]) {
    MW_BEGIN_MLX();
    {
        ...
        if (nlhs > 1) {
            error(mwVarargin(mwArray("Run-time Error: File: mymagic Line: 2 Column: 1 The function \"mymagic\" was called with more than the declared number of outputs (1).")));
        }
        if (nrhs > 1) {
            error(mwVarargin(mwArray("Run-time Error: File: mymagic Line: 2 Column: 1 The function \"mymagic\" was called with more than the declared number of inputs (1).")));
        }
...
//
// The function "Mmymagic" is the implementation version of the "mymagic" M-function from file "d:\vc2005\exp_13_3_5\mymagic.m" (lines 1-3). It contains the actual compiled code for that M-function. It is a static function and must only be called from one of the interface functions, appearing below.
//
//
// % Éú³Énxn»Ã·½¾ØÕóX
// function X = mymagic(n)
//
#line 2 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
static mwArray Mmymagic(int nargout_, mwArray n) {
    #line 2 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
    mclMlineEnterFunction("d:\\vc2005\\exp_13_3_5\\mymagic.m", "mymagic")
    #line 2 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
    mwLocalFunctionTable save_local_function_table_ = &_local_function_table_mymagic;
    #line 2 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
    mwArray X = mwArray::UNDEFINED;
    //
    // X = magic(n);
    //
    #line 3 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
    X = magic(mwVa(n, "n"));
    #line 3 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
    mwValidateOutput(X, 1, nargout_, "X", "mymagic");
    #line 3 "d:\\vc2005\\exp_13_3_5\\mymagic.m"
