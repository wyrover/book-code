// DlgImageMatchGYH.cpp : implementation file
//
...
CDlgImageMatchGYH::CDlgImageMatchGYH(CWnd* pParent /*=NULL*/, CImageMatchingDoc* pDoc)
	: CDialog(CDlgImageMatchGYH::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgImageMatchGYH)
...
void CDlgImageMatchGYH::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgImageMatchGYH)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlgImageMatchGYH, CDialog)
	//{{AFX_MSG_MAP(CDlgImageMatchGYH)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgImageMatchGYH message handlers

void CDlgImageMatchGYH::CalImageLocation()
{
...
void CDlgImageMatchGYH::OnOpentemplate() 
{
...
void CDlgImageMatchGYH::OnImagematch() 
{
	// TODO: Add your control notification handler code here
	// 更改光标形状
	BeginWaitCursor();
	...
	if (ImageMatchGYH(m_pDibResult, m_pDibModel))
	{
		// 更新显示
		Invalidate();
	}
...
void CDlgImageMatchGYH::OnCancel() 
{
...
void CDlgImageMatchGYH::OnPaint() 
{
...
BOOL CDlgImageMatchGYH::ImageMatchGYH(CDib* pDibSrc, CDib* pDibTemplate)
{
	// 指向源图像的指针
	...
	for(i=0; i<nImageHeight; i++)
		for( j=0; j<nImageWidth; j++){
			lpDst[i*sizeSaveImage.cx +j] /=2;	//变暗？		
		}
