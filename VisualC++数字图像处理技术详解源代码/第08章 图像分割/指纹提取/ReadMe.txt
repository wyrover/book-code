================================================================================
MICROSOFT 基础类库: Fngprnt 项目概述
===============================================================================

应用程序向导已为您创建了这个 Fngprnt 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
res\Fngprnt.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 Fngprnt.rc 中。
...
res\Toolbar.bmp
此位图文件用于为工具栏创建平铺图像。
初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 Fngprnt.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一个文档类型和一个视图:

FngprntDoc.h，FngprntDoc.cpp - 文档
这些文件包含 CFngprntDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CFngprntDoc::Serialize)。

FngprntView.h，FngprntView.cpp - 文档的视图
这些文件包含 CFngprntView 类。
CFngprntView 对象用于查看 CFngprntDoc 对象。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 Fngprnt.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
