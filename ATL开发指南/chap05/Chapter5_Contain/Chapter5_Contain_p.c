...
/* Object interface: IMath, ver. 0.0,
   GUID={0x380F79EA,0x4098,0x11D1,{0x88,0x3A,0x44,0x45,0x53,0x54,0x00,0x00}} */
...
const CInterfaceProxyVtbl * _Chapter5_Contain_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IMathProxyVtbl,
    (CInterfaceProxyVtbl *) &_IAdvancedMathProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Chapter5_Contain_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IMathStubVtbl,
    (CInterfaceStubVtbl *) &_IAdvancedMathStubVtbl,
    0
};

PCInterfaceName const _Chapter5_Contain_InterfaceNamesList[] = {
    "IMath",
    "IAdvancedMath",
    0
};
...
#define _Chapter5_Contain_CHECK_IID(n)  IID_GENERIC_CHECK_IID( _Chapter5_Contain, pIID, n)

int __stdcall _Chapter5_Contain_IID_Lookup(const IID * pIID, int * pIndex)
{
    IID_BS_LOOKUP_SETUP
    IID_BS_LOOKUP_INITIAL_TEST(_Chapter5_Contain, 2, 1)
    IID_BS_LOOKUP_RETURN_RESULT(_Chapter5_Contain, 2, *pIndex)
}

const ExtendedProxyFileInfo Chapter5_Contain_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _Chapter5_Contain_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Chapter5_Contain_StubVtblList,
    (const PCInterfaceName *) & _Chapter5_Contain_InterfaceNamesList,
    0, // no delegation
    & _Chapter5_Contain_IID_Lookup,
    2,
    2
};
