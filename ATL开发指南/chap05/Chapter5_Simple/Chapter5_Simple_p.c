...
const CInterfaceProxyVtbl * _Chapter5_Simple_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IMathProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Chapter5_Simple_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IMathStubVtbl,
    0
};

PCInterfaceName const _Chapter5_Simple_InterfaceNamesList[] = {
    "IMath",
    0
};


#define _Chapter5_Simple_CHECK_IID(n)   IID_GENERIC_CHECK_IID( _Chapter5_Simple, pIID, n)

int __stdcall _Chapter5_Simple_IID_Lookup(const IID * pIID, int * pIndex)
{
    if (!_Chapter5_Simple_CHECK_IID(0)) {
        *pIndex = 0;
        return 1;
    }
...
const ExtendedProxyFileInfo Chapter5_Simple_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _Chapter5_Simple_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Chapter5_Simple_StubVtblList,
    (const PCInterfaceName *) & _Chapter5_Simple_InterfaceNamesList,
    0, // no delegation
    & _Chapter5_Simple_IID_Lookup,
    1,
    2
};
