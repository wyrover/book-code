...
/* Object interface: IMath, ver. 0.0,
   GUID={0x99D952C7,0x99E6,0x11D3,{0x83,0x66,0x00,0x60,0x08,0x1A,0xEB,0x5F}} */
...
const CInterfaceProxyVtbl * _Chapter7_CPServer_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IMathProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Chapter7_CPServer_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IMathStubVtbl,
    0
};

PCInterfaceName const _Chapter7_CPServer_InterfaceNamesList[] = {
    "IMath",
    0
};

const IID *  _Chapter7_CPServer_BaseIIDList[] = {
    &IID_IDispatch,
    0
};


#define _Chapter7_CPServer_CHECK_IID(n) IID_GENERIC_CHECK_IID( _Chapter7_CPServer, pIID, n)

int __stdcall _Chapter7_CPServer_IID_Lookup(const IID * pIID, int * pIndex)
{
    if (!_Chapter7_CPServer_CHECK_IID(0)) {
        *pIndex = 0;
        return 1;
    }
...
const ExtendedProxyFileInfo Chapter7_CPServer_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _Chapter7_CPServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Chapter7_CPServer_StubVtblList,
    (const PCInterfaceName *) & _Chapter7_CPServer_InterfaceNamesList,
    (const IID **) & _Chapter7_CPServer_BaseIIDList,
    & _Chapter7_CPServer_IID_Lookup,
    1,
    2,
