...
/* Object interface: IMath, ver. 0.0,
   GUID={0xF7435692,0x6868,0x11D1,{0x80,0x12,0x00,0x00,0x00,0x00,0x00,0x00}} */
...
const CInterfaceProxyVtbl * _Chapter10_BothServer_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IMathProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Chapter10_BothServer_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IMathStubVtbl,
    0
};

PCInterfaceName const _Chapter10_BothServer_InterfaceNamesList[] = {
    "IMath",
    0
};


#define _Chapter10_BothServer_CHECK_IID(n)  IID_GENERIC_CHECK_IID( _Chapter10_BothServer, pIID, n)

int __stdcall _Chapter10_BothServer_IID_Lookup(const IID * pIID, int * pIndex)
{
    if (!_Chapter10_BothServer_CHECK_IID(0)) {
        *pIndex = 0;
        return 1;
    }
...
const ExtendedProxyFileInfo Chapter10_BothServer_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _Chapter10_BothServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Chapter10_BothServer_StubVtblList,
    (const PCInterfaceName *) & _Chapter10_BothServer_InterfaceNamesList,
    0, // no delegation
    & _Chapter10_BothServer_IID_Lookup,
    1,
    2
};
