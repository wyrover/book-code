...
/* Object interface: IMath, ver. 0.0,
   GUID={0xEBFEC172,0x67FA,0x11D1,{0xB5,0xF9,0x00,0x04,0xAC,0xFF,0x17,0x1C}} */
...
const CInterfaceProxyVtbl * _Chapter10_Server_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IMathProxyVtbl,
    (CInterfaceProxyVtbl *) &_ICallBackProxyVtbl,
    0
};

const CInterfaceStubVtbl * _Chapter10_Server_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IMathStubVtbl,
    (CInterfaceStubVtbl *) &_ICallBackStubVtbl,
    0
};

PCInterfaceName const _Chapter10_Server_InterfaceNamesList[] = {
    "IMath",
    "ICallBack",
    0
};
...
#define _Chapter10_Server_CHECK_IID(n)  IID_GENERIC_CHECK_IID( _Chapter10_Server, pIID, n)

int __stdcall _Chapter10_Server_IID_Lookup(const IID * pIID, int * pIndex)
{
    IID_BS_LOOKUP_SETUP
    IID_BS_LOOKUP_INITIAL_TEST(_Chapter10_Server, 2, 1)
    IID_BS_LOOKUP_RETURN_RESULT(_Chapter10_Server, 2, *pIndex)
}

const ExtendedProxyFileInfo Chapter10_Server_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _Chapter10_Server_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Chapter10_Server_StubVtblList,
    (const PCInterfaceName *) & _Chapter10_Server_InterfaceNamesList,
    0, // no delegation
    & _Chapter10_Server_IID_Lookup,
    2,
    2
};
