...
#include "Chapter6_NativeServer.h"
...
/* Object interface: IMath, ver. 0.0,
   GUID={0xB8721602,0x4A3D,0x11d1,{0x88,0x3A,0x44,0x45,0x53,0x54,0x00,0x00}} */
...
const CInterfaceProxyVtbl * _NativeServer_ProxyVtblList[] = {
    (CInterfaceProxyVtbl *) &_IMathProxyVtbl,
    0
};

const CInterfaceStubVtbl * _NativeServer_StubVtblList[] = {
    (CInterfaceStubVtbl *) &_IMathStubVtbl,
    0
};

PCInterfaceName const _NativeServer_InterfaceNamesList[] = {
    "IMath",
    0
};

const IID *  _NativeServer_BaseIIDList[] = {
    &IID_IDispatch,
    0
};


#define _NativeServer_CHECK_IID(n)  IID_GENERIC_CHECK_IID( _NativeServer, pIID, n)

int __stdcall _NativeServer_IID_Lookup(const IID * pIID, int * pIndex)
{
    if (!_NativeServer_CHECK_IID(0)) {
        *pIndex = 0;
        return 1;
    }
...
const ExtendedProxyFileInfo NativeServer_ProxyFileInfo = {
    (PCInterfaceProxyVtblList *) & _NativeServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _NativeServer_StubVtblList,
    (const PCInterfaceName *) & _NativeServer_InterfaceNamesList,
    (const IID **) & _NativeServer_BaseIIDList,
    & _NativeServer_IID_Lookup,
    1,
    2,
